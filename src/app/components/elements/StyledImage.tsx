...
export default function StyledImage({ imageSrc, altText, size }: StyledImageProps) {
    ...
    return (
        <div className={`relative w-52 h-52 xl:w-72 xl:h-72 flex justify-center items-center overflow-visible mb-4 xl:mb-0 ${size == "Stor bild" ? "mt-8 scale-110 xl:scale-150 xl:ml-16 xl:mt-0" : "scale-100 xl:ml-0"}`}>
